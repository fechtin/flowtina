...
class GrowthService:
    ...
    async def generate_draft(self, page_id: str, project_id: str, topic_id: str, content_type: str | None = None) -> ContentDraft:
        ...
        style = cfg.writing_style or "conversational"
        language = cfg.language if cfg else "en"
        audience = cfg.target_audience or "general public"
        emoji_level = cfg.emoji_level if cfg else "moderate"
        cta_style = cfg.cta_style or "soft"
        brand_personality = cfg.brand_personality or "friendly and professional"
        forbidden = cfg.forbidden_topics or ""
